...
namespace ArmelWanes\Crudify\Asset;

use Psr\Cache\CacheItemPoolInterface;
use Symfony\WebpackEncoreBundle\Exception\EntrypointNotFoundException;

/**
 * Returns the CSS or JavaScript files needed for a Crudify entry.
 *
 * This reads a JSON file with the format of Crudify's entrypoints.json file.
 *
 * @final
 */
